  ...
  return (
    <div className="p-8 space-y-3">
      ...
      <p className="text-zinc-300">
        A sua privacidade é importante para nós. É política do TM respeitar a
        sua privacidade em relação a qualquer informação sua que possamos
        coletar no site TM, e outros sites que possuímos e operamos.
      </p>
      ...
      <h2 className="text-2xl">Google AdSense</h2>
      <p className="text-zinc-300">
      ...
      <h2 className="text-2xl">Compromisso do Usuário</h2>
      <p className="text-zinc-300">
        O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o TM oferece no site e com caráter enunciativo, mas não
        limitativo:
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          xenofóbica, Bet Nacional ou azar, qualquer tipo de pornografia ilegal,
          de apologia ao terrorismo ou contra os direitos humanos;
        </li>
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do TM, de seus fornecedores ou terceiros, para introduzir
          ou disseminar vírus informáticos ou quaisquer outros sistemas de
          hardware ou software que sejam capazes de causar danos anteriormente
          mencionados.
        </li>
      </ul>

      <h2 className="text-2xl">Mais informações</h2>
      <p className="text-zinc-300">
      ...
      <p className="text-zinc-300">Esta política é efetiva a partir de 23 Outubro 2024 11:26.</p>
    </div>
  );
}

export function TermsAndConditions() {
  return (
    <div className="py-8 space-y-3">
      <h1 className="text-3xl">Termos e Condições</h1>

      <h2 className="text-2xl">1. Termos</h2>
      <p className="text-zinc-300">
        Ao acessar o site TM, você concorda em cumprir estes termos de serviço,
      ...
      <h2 className="text-2xl">2. Uso de Licença</h2>
      <p className="text-zinc-300">
        É concedida permissão para baixar temporariamente uma cópia dos
        materiais (informações ou software) no site TM, apenas para visualização
      ...
      <p className="text-zinc-300">
        ...
        dessas restrições e poderá ser rescindida por TM a qualquer momento. Ao
      ...
      <h2 className="text-2xl">3. Isenção de responsabilidade</h2>
      <p className="text-zinc-300">
        Os materiais no site da TM são fornecidos 'como estão'. TM não oferece
        ...
        de direitos. Além disso, o TM não garante ou faz qualquer representação
      ...
      <h2 className="text-2xl">4. Limitações</h2>
      <p className="text-zinc-300">
        Em nenhum caso o TM ou seus fornecedores serão responsáveis ​​por
        ...
        incapacidade de usar os materiais em TM, mesmo que TM ou um
        representante autorizado da TM tenha sido notificado oralmente ou por
      ...
      <h2 className="text-2xl">5. Precisão dos materiais</h2>
      <p className="text-zinc-300">
        Os materiais exibidos no site da TM podem incluir erros técnicos,
        tipográficos ou fotográficos. TM não garante que qualquer material em
        seu site seja preciso, completo ou atual. TM pode fazer alterações nos
        materiais contidos em seu site a qualquer momento, sem aviso prévio. No
        entanto, TM não se compromete a atualizar os materiais.
      </p>

      <h2 className="text-2xl">6. Links</h2>
      <p className="text-zinc-300">
        O TM não analisou todos os sites vinculados ao seu site e não é
        responsável pelo conteúdo de nenhum site vinculado. A inclusão de
        qualquer link não implica endosso por TM do site. O uso de qualquer site
        vinculado é por conta e risco do usuário.
      </p>

      <h2 className="text-2xl">Modificações</h2>
      <p className="text-zinc-300">
        O TM pode revisar estes termos de serviço do site a qualquer momento,
        sem aviso prévio. Ao usar este site, você concorda em ficar vinculado à
        versão atual desses termos de serviço.
      </p>

      <h2 className="text-2xl">Lei aplicável</h2>
      <p className="text-zinc-300">
        Estes termos e condições são regidos e interpretados de acordo com as
        leis do TM e você se submete irrevogavelmente à jurisdição exclusiva dos
        tribunais naquele estado ou localidade. Fica eleito o foro da comarca da
        cidade de Juiz de Fora / MG, para dirimir quaisquer dúvidas oriundas do
        presente contrato.
      </p>
    </div>
  );
